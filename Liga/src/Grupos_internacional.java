...
public class Grupos_internacional {
    ...
    public Grupos_internacional() {
    }

    public Grupos_internacional(String nombre_grupo, String equipo1, String equipo2, String equipo3, String equipo4, int puntose1, int puntose2, int puntose3, int puntose4) {
